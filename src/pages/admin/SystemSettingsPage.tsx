...
const SettingCard = ({ row }: { row: SettingRow }) => (
 <div className="rounded-sm bg-muted/20 p-3">
...
const SystemSettingsPage = () => {
 ...
 <LoadingState rows={4} className="grid gap-3 md:grid-cols-2 xl:grid-cols-4" itemClassName="h-28 rounded-sm" />
 <LoadingState rows={4} className="grid gap-3 xl:grid-cols-2" itemClassName="h-72 rounded-sm" />
 </ConsolePage>
 );
 }
 ...
 <div className="rounded-sm bg-info/10 px-3 py-2 text-sm text-info">
