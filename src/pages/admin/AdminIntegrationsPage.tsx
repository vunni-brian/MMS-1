...
const AdminIntegrationsPage = () => {
 ...
 {isLoading ? (
 <div className="p-4">
 <LoadingState rows={6} className="grid gap-3 md:grid-cols-2 xl:grid-cols-3" itemClassName="h-[160px] rounded-sm" />
 </div>
 ) : (
 ...
 <div key={event.id} className="rounded-sm border border-border/70 bg-background px-3 py-2">
