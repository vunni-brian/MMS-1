  ...
  return (
    <ConsolePage>
      ...
      >
        {isLoading ? (
          <div className="p-4">
            <LoadingState rows={8} className="grid gap-3 md:grid-cols-2 xl:grid-cols-3" itemClassName="h-[190px] rounded-xl" />
          </div>
          ...
          <div className="admin-market-grid p-4">
            {filteredMarkets.map((market) => (
              <article
                key={market.id}
                className="admin-market-card cursor-pointer transition-shadow hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
