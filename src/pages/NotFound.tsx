...
const NotFound = () => {
 ...
 <p className="mt-4 w-fit rounded-sm border border-slate-200 bg-white px-3 py-2 font-mono text-xs text-slate-600">
 {location.pathname}
 </p>
 ...
 <section className="relative min-h-[340px] overflow-hidden rounded-sm border border-slate-200 bg-white p-8 shadow-[0_24px_70px_-48px_rgba(15,23,42,0.55)]">
