...
export const permissionLabels: Record<Permission, string> = {
 ...
 "booking:update": "Review bookings",
  ...
  "payment:verify": "Verify payment receipts",
...
export const permissionGroups: Array<{ title: string; permissions: Permission[] }> = [
 ...
 {
 title: "Financial",
  permissions: ["billing:read", "billing:manage", "payment:read", "payment:create", "payment:verify", "utility:read", "utility:manage", "penalty:read", "penalty:manage"],
 },
 {
 title: "Workflow",
