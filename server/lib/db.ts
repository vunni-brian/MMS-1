...
export const seedDatabase = async () => {
  ...
  const locations = [
    ...
    { id: "loc_subarea_testbed", name: "Kampala CBD", type: "subcounty", parentId: "loc_area_kampala" },
    { id: "loc_market_kampala_central", name: "Busega Market", type: "market", parentId: "loc_subarea_kampala_central" },
    { id: "loc_market_jinja_main", name: "Owino market", type: "market", parentId: "loc_subarea_jinja_municipality" },
    { id: "loc_market_demo_test", name: "Wandegeya market", type: "market", parentId: "loc_subarea_testbed" },
    { id: "loc_market_nakasero", name: "Nakasero Market", type: "market", parentId: "loc_subarea_kampala_central" },
    { id: "loc_market_park_yard", name: "Park Yard Market", type: "market", parentId: "loc_subarea_kampala_central" },
  ] as const;
  ...
  const markets = [
    ...
    },
    {
      ...
      code: "NAKASERO",
      location: "Kampala",
      locationId: "loc_market_nakasero",
    },
    {
      id: "market_park_yard",
      name: "Park Yard Market",
      code: "PARK-YARD",
      location: "Kampala",
      locationId: "loc_market_park_yard",
    },
  ] as const;
